...
rh = window.rh;
model = rh.model;
var defaultTopic = "athena_datamanagement_aggregatedschoolscalendarsadmin.html";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("athena_datamanagement_aggregatedschoolscalendarsadmin.html"));
rh.consts('HOME_FILEPATH', encodeURI('index.html'));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '264e5e72-2821-4d4a-8a80-10097192b25b' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Athena Online Help");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "BlueLagoon");
